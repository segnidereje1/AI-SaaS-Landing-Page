...
export default function Pricing() {
  return (
    <section id="pricing" className="scroll-mt-28 py-16 sm:py-20">
      <Reveal className="relative overflow-hidden rounded-[2.25rem] border border-ink-200 bg-[linear-gradient(135deg,rgba(255,248,232,0.95),rgba(255,255,255,0.96))] p-8 shadow-[0_20px_60px_rgba(15,23,42,0.1)] sm:p-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(194,145,29,0.18),transparent_32%),radial-gradient(circle_at_bottom_left,rgba(124,92,255,0.08),transparent_28%)]" />
