      ...
      <div className="grid items-center gap-10 lg:grid-cols-[1.02fr_0.98fr]">
        <div>
          <motion.h1
            ...
            className="mt-6 max-w-3xl text-5xl font-semibold tracking-tight text-cream sm:text-6xl lg:text-[4.8rem] lg:leading-[0.95]"
          >
            Premium AI
            <span className="gold-gradient block">for serious teams.</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-5 max-w-xl text-base leading-7 text-soft sm:text-lg"
          >
            Aurelia pairs quiet visuals with clear workflows, so the product feels polished without feeling busy.
          </motion.p>
        </div>
          ...
          >
            ...
            <div className="theme-surface relative rounded-[1.5rem] border border-white/10 p-4 backdrop-blur-xl">
              <div className="theme-border flex items-center justify-between border-b pb-4">
                <div>
                  <div className="text-xs uppercase tracking-[0.24em] text-gold-200">Live view</div>
                  <div className="mt-1 text-lg font-semibold text-cream">Aurelia suite</div>
                </div>
              ...
              <div className="mt-4 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
                <div className="theme-accent-panel theme-panel rounded-[1.5rem] p-4">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-soft">Weekly pulse</div>
